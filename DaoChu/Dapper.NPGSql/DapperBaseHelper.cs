...
{
    public abstract class DapperBaseHelper : IDapperHelper
    {
        ...
        public void ExecuteAsync(string sql, object param = null)
        {
            try
            {
                using (var conn = GetConnection())
                {
                    conn.ExecuteAsync(sql: sql, param: param);
                }
            }
            catch (Exception ex)
            {
        ...
        public virtual Type GetType(string tableName)
        {
        ...
        public virtual Type ConvertType(List<FieldDto> fieldDtos)
        {
            ...
            foreach (var property in fieldDtos)
                AddProperty(dynamicType, property.FieldName, GetFieldType(property.FieldType));
